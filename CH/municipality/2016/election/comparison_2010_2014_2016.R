...
yes2014 <- select(i2014, id, yes_percentage)
yes2010 <- select(i2010, id, yes_percentage)

m1 <- merge(yes2010, yes2014, by="id")
m2 <- merge(m1, yes2016, by="id")

m2$yes2010 <- m2$yes_percentage.x
m2$yes2014 <- m2$yes_percentage.y
m2$yes2016 <- m2$yes_percentage
...
m2 <- mutate(m2,
       no_change2010_2014 = yes2010 - yes2014,
       no_change2014_2016 = yes2014 - yes2016,
       no_change2010_2016 = yes2010 - yes2016)
